...
### Fixed
- Fixed color effect not working when enabled
- Fixed color adjustments applying changes even with default values
- Improved color effect ranges for more dramatic results:
  - Extended brightness range (0-300%)
  - Extended contrast range (0-300%)
  - Enhanced saturation adjustment with non-linear scaling
